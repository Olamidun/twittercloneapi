...
urlpatterns = [
    ...
    path('comment/<str:id>', views.delete_comment, 
    name="delete-comment"),
    path('comment/<str:id>/like_comment', views.like_comment, name="like-comment"),
    path('comment/<str:id>/unlike_comment', views.unlike_comment, name="unlike-comment")
]